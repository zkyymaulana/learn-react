		...
		<div>
			<div className="container">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 place-items-center">
					{[...(products.length > 0 ? products : Array(20).fill({}))].slice(0, 3).map((product, index) => (
						<div
							data-aos="fade-up"
						...
						>
							...
							<div>
								<img
									src={product.image || 'https://via.placeholder.com/300'} // Placeholder jika gambar tidak tersedia
								...
								<div className="p-4 text-center grid gap-1">
									...
									<h1 className="text-xl font-bold line-clamp-1">{product.title || 'Product Title'}</h1>
									<p className="text-gray-500 group-hover:text-white duration-300 text-sm line-clamp-2">{product.description || 'No description available.'}</p>
